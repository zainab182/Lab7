...
public class RPSLSpock {
    ...
    /**
     * checking if player's choice is valid or not
     * @param pick is player's choice
     * @return checking the valid choice
     */
    ...
    /**
     * @param c_pick is the computer pick
     * @param h_pick is the player pick
     * @return is computer wins otherwise not
     */
